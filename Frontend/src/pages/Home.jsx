          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            md:leading-[70px]"
                ...
                <p className="text__para">
                  ...
                  Molestias eveniet voluptas cupiditate porro ullam commodi,
              ...
              text-headingColor"
                  ...
                  <span className="w-[80px] h-2 bg-yellowColor rounded-full block mt-[-5px]"></span>
              ...
              text-headingColor"
                  ...
                  <span className="w-[80px] h-2 bg-purpleColor rounded-full block mt-[-5px]"></span>
              ...
              text-headingColor"
                  ...
                  <span className="w-[100px] h-2 bg-cyan-500 rounded-full block mt-[-5px]"></span>
        ...
        lg:mt-[55px]"
          >
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                <h2 className="text-[26px] leading-7 text-textColor font-[700] text-center">
                  Find Doctor
                </h2>
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  World-class medical care for everyone. Out health system
                  offers is unmatched, expert health care from lab to clinics.
                </p>
                <Link
                  to="/doctors"
