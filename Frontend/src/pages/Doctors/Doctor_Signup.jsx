import signupImg from "../../assets/images/about.png";
...
const DoctorSignup = () => {
  ...
  useEffect(() => {
    if (selectedFile) {
      setFormData((prevData) => ({ ...prevData, photo: selectedFile }));
    }
  }, [selectedFile]);
  ...
  const submitHandler = async (event) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`${BASE_URL}/auth/doctors_signup`, {
        method: "post",
        headers: {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l-lg lg:pl-16 py-0">
            <h3 className="text-headingColor text-[22px] leading-9 font-bold mb-10">
              Create your{" "}
              <span className="text-primaryColor">MediPlus Doctor Account</span>
            </h3>
